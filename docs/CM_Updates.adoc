...
* "Stateless clients" functionality (remote calls) has been removed. Contact mailto:sales@chronicle.software[sales@chronicle.software] if you need help with this.
