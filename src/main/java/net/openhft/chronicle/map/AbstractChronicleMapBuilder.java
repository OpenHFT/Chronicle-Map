 ...
 * ChronicleHashBuilder} interface documentation. </p> <p>Later in this documentation,
 * "ChronicleMap" means "ChronicleMaps, created by {@code AbstractChronicleMapBuilder}", unless
 * specified different, because theoretically someone might provide {@code ChronicleMap}
 * implementations with completely different properties. </p> <p>{@code ChronicleMap}
 * ("ChronicleMaps, created by {@code AbstractChronicleMapBuilder}") currently doesn't support
 ...
 * {@link #entrySize(int)} method documentation for more information on this. </p>
 *
...
public abstract class AbstractChronicleMapBuilder<K, V,
     ...
     * #valueSize(int) value size}, if they couldn't be derived statically. </p> <p>If entry size is
     * not configured explicitly by calling this method, it is computed based on {@linkplain
     * #metaDataBytes(int) meta data bytes}, plus {@linkplain #keySize(int) key size}, plus
     ...
     * for something you probably don't use. </p> <p>By default, of cause, {@code ChronicleMap}
     * conforms the general {@code Map} contract and returns the previous mapped value on {@code
     * put()} calls. </p>
     *
     ...
     * something you probably don't use. </p>
     *
     ...
     * internally delegates to instance pool or {@link ThreadLocal}, to reduce allocations. </p>
     *
     ...
     * this {@code AbstractChronicleMapBuilder}. </p>
     *
