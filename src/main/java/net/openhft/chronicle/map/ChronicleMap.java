...
public interface ChronicleMap<K, V> extends ConcurrentMap<K, V>, ChronicleHash {
     ...
     * AbstractChronicleMapBuilder#defaultValueProvider(DefaultValueProvider)
     ...
     * OffHeapUpdatableChronicleMapBuilder#prepareValueBytesOnAcquire(PrepareValueBytes)}. By
     * default, value bytes are just zeroed out, no default value, either provided for key or
