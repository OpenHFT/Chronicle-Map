...
import static net.openhft.chronicle.map.StatelessChronicleMapUnsynchronized.EventId.*;

/**
 * @author Rob Austin.
 */
class StatelessChronicleMapUnsynchronized<K, V> implements ChronicleMap<K, V>, Closeable {

    public static final String START_OF = "Attempt to write ";
    private static final Logger LOG = LoggerFactory.getLogger(StatelessChronicleMapUnsynchronized.class);
    ...
    StatelessChronicleMapUnsynchronized(final StatelessMapConfig config,
     ...
     * net.openhft.chronicle.map.StatelessChronicleMapUnsynchronized#lazyConnect(long,
     * java.net.InetSocketAddress)} will attempt to establish the connection when the client make the first
     * map method call.
     *
     * @param remoteAddress
     * @return
     * @throws java.io.IOException
     * @see net.openhft.chronicle.map.StatelessChronicleMapUnsynchronized#lazyConnect(long,
    ...
    private long writeEvent(StatelessChronicleMapUnsynchronized.EventId event) {
        buffer.clear();
        bytes.clear();
    ...
    class Entry implements Map.Entry<K, V> {
        ...
        public final V setValue(V newValue) {
            V oldValue = value;
            StatelessChronicleMapUnsynchronized.this.put((K) getKey(), (V) newValue);
            return oldValue;
        }
