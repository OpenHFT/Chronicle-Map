...
/**
 * Core staged implementation of a Chronicle-Map query context.
 * <p>
 * This class combines hash-level {@link HashQuery} behaviour with map and set
 * specific views, driving key lookup, absent-entry handling and return value
 * strategy selection. Concrete contexts generated by the staging framework
 * expose {@link MapEntry}, {@link ExternalMapQueryContext} and
 * {@link ExternalSetQueryContext} interfaces to higher layers.
 */
@Staged
