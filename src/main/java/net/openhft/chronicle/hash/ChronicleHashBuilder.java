...
public interface ChronicleHashBuilder<K, H extends ChronicleHash<K, ?, ?, ?>,
     ...
     * <p>
     * {@code name()} is a JVM-level configuration, it is not stored in the persistence file (or
     ...
     * this one.
     * <p>
     * Calling this method clears any previous {@link #averageKey(Object)} and
     * {@link #averageKeySize(double)} configurations.
     *
     ...
     *     .create();}</pre>
     * <p>
     * This is a <a href="#low-level-config">low-level configuration</a>. The configured number
     ...
     * <p>
     * Default is {@code true}, segments are allowed to tier.
     * <p>
     * When configured to {@code false}, {@link #maxBloatFactor(double)} configuration becomes
     ...
     * <p>
     * This configuration affects the actual number of segments, if {@link #entries(long)} and
     ...
     * <p>
     * This is a <a href="#low-level-config">low-level configuration</a>.
     *
     ...
     * <p>
     * Default key size marshaller is so-called "stop bit encoding" marshalling. If {@linkplain
     ...
     * <p>
     * By default, {@linkplain #createPersistedTo(File) persisted} hash containers, created by
     ...
     * <p>
     * The difference between this method and {@link #recoverPersistedTo(File, boolean,
     ...
     * Chronicle Map tutorial for more information.
     * <p>
     * If this procedure encounters corruptions, it fixes them (<i>recovers</i> from them) and
