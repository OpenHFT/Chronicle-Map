...
public class PingPongCASLeft {
    ...
    static void playPingPong(ChronicleMap<String, BondVOInterface> chm, double coupon,
                             double coupon2, boolean setFirst, final String desc) {
        ...
        if (setFirst) {
            bond1.setCoupon(coupon);
            bond2.setCoupon(coupon);
            bond3.setCoupon(coupon);
            bond4.setCoupon(coupon);
        }
