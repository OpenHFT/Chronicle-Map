...
public class StatelessChronicleMapTest extends JSR166TestCase {
    ...
    static ChronicleMap<CharSequence, CharSequence> newShmStringString(int port) throws IOException {
     ...
     * @param port
     */
    private static ChronicleMap map5(final int port) throws IOException {
    ...
    public void testGet() throws IOException {
        ...
        ChronicleMap empty = newShmIntString(8077);
    ...
    public void testIsEmpty() throws IOException {
        ChronicleMap empty = newShmIntString(8078);
        ChronicleMap map = map5(8079);
    ...
    public void testPutAll() throws IOException {
        ChronicleMap empty = newShmIntString(8076);
        ChronicleMap map = map5(8076);
        empty.putAll(map);
   ...
   /*     ChronicleMap map = map5(8076);
    ...
    public void testRemove3() throws IOException {
        ChronicleMap c = newShmStringString(8077);
        c.put("sadsdf", "asdads");
