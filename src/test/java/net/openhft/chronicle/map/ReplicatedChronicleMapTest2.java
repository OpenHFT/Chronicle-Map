...
public class ReplicatedChronicleMapTest2 extends JSR166TestCase {

    boolean canReplicate;

    public ReplicatedChronicleMapTest2(Boolean canReplicate) {
    ...
    ChronicleMap<Integer, CharSequence> newShmIntString(int size) throws IOException {
        ...
        final ChronicleMap<Integer, CharSequence> map1 =
                Builder.newShm(size, map1ToMap2, map2ToMap1, (byte) 1, (byte) 2,
                        Integer.class, CharSequence.class);
        final ChronicleMap<Integer, CharSequence> map2 =
    ...
    ChronicleMap<CharSequence, CharSequence> newShmStringString(int size) throws IOException {
        ...
        final ChronicleMap<CharSequence, CharSequence> map1 =
                Builder.newShm(size, map1ToMap2, map2ToMap1, (byte) 1, (byte) 2,
                        CharSequence.class, CharSequence.class);
        final ChronicleMap<CharSequence, CharSequence> map2 =
                Builder.newShm(size, map2ToMap1, map1ToMap2, (byte) 2, (byte) 1,
                        CharSequence.class, CharSequence.class);
